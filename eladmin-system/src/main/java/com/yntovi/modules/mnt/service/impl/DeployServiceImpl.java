package com.yntovi.modules.mnt.service.impl;
...
import com.yntovi.modules.mnt.domain.*;
import com.yntovi.modules.mnt.mapper.DeploysServersMapper;
import com.yntovi.modules.mnt.mapper.ServerMapper;
import com.yntovi.modules.mnt.service.*;
import com.yntovi.modules.mnt.service.dto.*;
import com.yntovi.modules.mnt.util.ExecuteShellUtil;
import com.yntovi.modules.mnt.util.ScpClientUtil;
import com.yntovi.modules.mnt.websocket.MsgType;
import com.yntovi.modules.mnt.websocket.SocketMsg;
import com.yntovi.modules.mnt.websocket.WebSocketServer;
import com.yntovi.utils.BeanCopyUtil;
import com.yntovi.utils.ConvertUtil;
import com.yntovi.utils.FileUtil;
import com.yntovi.modules.mnt.mapper.DeployMapper;
...
public class DeployServiceImpl extends CommonServiceImpl<DeployMapper, Deploy> implements DeployService {
    ...
    public DeployDto findById(Long id) {
        ...
        List<Server> serverList = serverMapper.selectAllByDeployId(id);
        Set<ServerDto> serverDtoSet = BeanCopyUtil.copyListToSet(serverList, ServerDto.class);
        deployDto.setDeploys(serverDtoSet);
        return deployDto;
    }
